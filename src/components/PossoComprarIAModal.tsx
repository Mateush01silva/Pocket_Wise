    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <button
          ...
          className={cn(
            'mt-2 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold transition-all duration-150',
            pergunta.trim() && !isLoading
              ? 'bg-secondary-500 text-white hover:bg-secondary-400 active:scale-[0.98]'
