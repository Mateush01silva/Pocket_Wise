// import { useState } from 'react'  // Não usado por enquanto
...
export function DashboardFixed() {
  // const [isModalOpen, setIsModalOpen] = useState(false)  // Modal desabilitado temporariamente
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <Button onClick={() => alert('Modal em breve!')} className="gap-2">
      ...
      {/* Modal - Removido temporariamente para evitar loop */}
