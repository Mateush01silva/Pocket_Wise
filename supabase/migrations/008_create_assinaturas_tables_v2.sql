-- =====================================================
-- Migration: Create Assinaturas Tables (Simplified Version)
-- Descrição: Criar tabelas para gerenciamento de assinaturas recorrentes
-- Data: 2026-01-19
-- Feature: #4 - Gestão de Assinaturas
-- Versão: 2.0 (sem family_id - Feature 3 não implementada ainda)
-- =====================================================
...
BEGIN
    ...
    ELSE
        RAISE EXCEPTION '✗ Erro: Coluna assinatura_id não foi adicionada';
    END IF;
